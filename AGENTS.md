...
- Treat every Flutter bridge package as unverified until it passes the Android device spike, license check, and test suite.
...
- Keep actual SDK versions, platform requirements, permissions, and bridge details unverified until tested and recorded.

## Verification Rules

- Do not call this documentation scaffold an executable Flutter app.
